...
<Terminal title="bandit2@bandit" prompt="bandit2@bandit:~$ " command="ls -la" output="-rw-r-----   1 bandit3 bandit2   33 ... --spaces in this filename--" />
...
<Terminal title="bandit2@bandit" prompt="bandit2@bandit:~$ " command="cat ./--spaces\ in\ this\ filename--" output="(password for bandit3)" />
